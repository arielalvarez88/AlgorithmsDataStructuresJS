...
describe("GraphProblems test suite", () => {
  ...
  describe("Algo Sanjoy: find longest increasing subsequence in a sequence of numbers. Chapter 6.2.", () => {
    describe("Normal cases", () => {
      test("Multiple subsequences", () => {
        const sequence = [5, 2, 8, 6, 3, 6, 9, 7];
        const solution = [2, 3, 6, 9];
        expect(GraphsProblems.longestIncreasingSubsequence(sequence)).toEqual(
          solution
        );
      });
      test("Just one subsequence 1", () => {
        const sequence = [6, 4, 6, 8];
        const solution = [4, 6, 8];
        expect(GraphsProblems.longestIncreasingSubsequence(sequence)).toEqual(
          solution
        );
      });
      test("Just one subsequence 2", () => {
      ...
      describe("Numbers with no subsequence", () => {
        test("Should have length 1", () => {
          const sequence = [10, 9, 8];
          expect(
            GraphsProblems.longestIncreasingSubsequence(sequence).length
          ).toEqual(1);
        });
      });
    });
    describe("Extreme cases", () => {
      ...
      describe("Empty sequence", () => {
        test("Solution should have length 0", () => {
          const sequence = [];
          const solution = [];
          expect(GraphsProblems.longestIncreasingSubsequence(sequence)).toEqual(
            solution
